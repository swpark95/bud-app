    ...
    return (
      <div className="warehouse-detail">
        ...
        <div className="warehouse-detail__list">
          <Link to={`/warehouses/${whId}/inbound`} className="warehouse-detail__item">
          입고
          </Link>
          <Link to={`/warehouses/${whId}/outbound`} className="warehouse-detail__item">
          출고
          </Link>
          <Link to={`/warehouses/${whId}/stock`} className="warehouse-detail__item">
          창고 재고 현황
          </Link>
        </div>
      {/* — Footer — */}
